            ...
            <c:forEach var="pelicula" items="${peliculas}">
			  <tr>
				...
				<td>
					...
					<a href="${urlDelete }/${pelicula.id}" onclick='return confirm ("¿Esta seguro de eliminar la siguiente pelicula?")' class="btn btn-danger btn-sm" role="button" title="Eliminar"><span class="glyphicon glyphicon-trash"></span></a>
				</td>
			  </tr>
			</c:forEach>
